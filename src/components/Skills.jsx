    ...
    <div>
        <div
          ...
          >
            ...
            <div className="flex flex-col items-start sm:items-center md:flex-row md:justify-around md:items-center lg:pl-[50px] py-[40px] mb-[10px] ">
              <motion.div
              ...
              <motion.div
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.7 }}
                className="mt-[100px]   md:mt-[30px] w-[50%] md:w-[50%] h-[200px] text-blue-950  relative "
              >
